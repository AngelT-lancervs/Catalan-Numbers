...
var packedScenePath2 = "res://Escenas/Enemigos/Enemigo2.tscn"
var packedScenePath1 = "res://Escenas/T1/enemigo.tscn"
var packedScenePath3 = "res://Escenas/Enemigos/Enemigo3.tscn"
...
var enemy3 = ResourceLoader.load(packedScenePath3) as PackedScene
...
func _ready():
	...
	timer.paused = true
	await TRANSITION.mostrarFigura(7)
...
func progressBar():
	if player != null:
		$GUI/TextureProgressBar.value = $player.health/2
...
func comprobarWin():
	...
	var enemigos2 : Array[Enemigo2]
	var enemigos3: Array[Enemigo3]
	for child in get_children():
		if child is Enemigo:
		...
		if child is Enemigo3:
			enemigos3.append(child)
	print(enemigos.size())
	if enemigos.size() == 0 and tmp > enemyNumber and enemigos2.size() == 0 and enemigos3.size() == 0:
		if player != null:
...
func _on_portal_body_entered(body):
	if body != null and !(body is Enemigo2) and !(body is Enemigo) and !(body is Enemigo3):
